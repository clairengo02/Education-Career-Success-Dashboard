...
The dashboards indicate a positive association between attendance and academic performance. Across all available terms, students with 100% attendance generally achieved higher term scores, while students with 80% attendance were more concentrated among the lower results. The upward regression line in the Attendance vs Student Performance chart supports this pattern.

Average attendance was similar across genders:

- Male students recorded approximately **94.67%** average attendance.
- Female students recorded approximately **93.00%** average attendance.
- The difference was only **1.67 percentage points**, suggesting that gender was not a major factor in attendance within this dataset.

When **Term 4** was selected on the Education Performance Overview page, the average attendance rate increased to **97.5%**, alongside an **87.5% continuation rate**. Continuing students also generally achieved higher weekly scores than students who discontinued. This suggests that regular participation may be associated with both stronger academic outcomes and continued engagement with the program.

Attendance should not be treated as the only explanation for performance. Homework completion, attention, careful checking, and individual learning needs may also influence results. The dashboard identifies an association and does not prove that higher attendance directly causes higher marks.

#### Attendance-focused actions

Based on these findings, Pioneer Education could:
...
An example of specific attendance feedback is:

> Your attendance has affected your opportunity to practise and consolidate important skills. Attending lessons more consistently and completing the missed activities will help you improve your weekly results. We will review your progress again over the next few weeks.

The **97.5% attendance rate is a Term 4 result**, while the gender comparison and attendance-performance scatter chart represent all available terms. These results should not be presented as if they use the same filter context.
